...
class AlidayuAPI(object):
    ...
    APP_KEY_FIELD = 'ALIDAYU_accessKeyId'
    APP_SECRET_FIELD = 'ALIDAYU_accessSecret'
    SMS_SIGN_NAME_FIELD = 'ALIDAYU_SignName'
    SMS_TEMPLATE_CODE_FIELD = 'ALIDAYU_TemplateCode'
